...
.table-img {
    ...
    object-fit: cover; /* Garante que a imagem preencha o espaço sem distorcer (cortando as bordas se necessário) */
    border-radius: 8px; /* Borda arredondada (opcional) */
    box-shadow: 0 0 5px rgba(0,0,0,0.1); /* Sombra suave para destaque (opcional) */
}
</style>
                ...
                <div class="card-body p-4">
                    ...
                    <?php
                        ...
                        function getTurnoBadge($turno) {
                            switch ($turno) {
                                case 'manha': return '<span class="badge bg-primary text-white">Manhã</span>';
                                case 'tarde': return '<span class="badge bg-success text-white">Tarde</span>';
                                default: return '<span class="badge" style="background-color: #CC0F87; color: white;">Integral</span>';
                            }
                        }
