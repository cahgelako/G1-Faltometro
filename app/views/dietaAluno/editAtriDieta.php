        ...
        <div class="col-lg-6 col-md-8">
            <div class="card shadow-lg border-0 rounded-3">
                <div class="card-body p-4 p-md-5">
                    ...
                    <form method="POST">
                        <input type="hidden" readonly id="id_estudante" name="id_estudante" value="<?= htmlspecialchars($_GET['id_estudante']) ?>">

                        <div class="row">
                            <div class="col-12">
                                <div class="mb-4">
                                    <label for="dietas" class="form-label fw-bold text-muted">
                                        <i class="fas fa-list-check me-1"></i> Selecione as Dietas Disponíveis
                                    </label>
