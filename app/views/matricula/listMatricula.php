                ...
                <div class="card-body p-4">
                    ...
                    <?php
                        ...
                        function getTurnoBadgeMatricula($turno) {
                            switch ($turno) {
                                case 1: return '<span class="badge bg-primary text-white ms-1">M</span>'; // Manhã (Azul)
                                case 2: return '<span class="badge bg-success text-white ms-1">T</span>';  // Tarde (Verde)
                                case 3: return '<span class="badge" style="background-color: #CC0F87; color: white; margin-left: 4px;">I</span>'; // Integral (Roxo/Magenta)
                                default: return '';
                            }
                        }
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <div class="d-flex justify-content-center gap-2">
                                                        ...
                                                        <a href="./deleteMatricula&id=<?= $user['id_matricula'] ?>" title="Excluir" class="btn btn-sm btn-outline-danger" onclick="return confirm('Tem certeza que deseja excluir esta matrícula?')"><i class="fa fa-trash"></i></a>
                                                    </div>
                                                </td>
                                            </tr>
                                <?php 
