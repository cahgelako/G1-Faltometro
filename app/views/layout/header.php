...
<head>
    ...
    <style>
        ...
        body {
            ...
            /* 2. CORREÇÃO DA SOBREPOSIÇÃO: Adiciona padding para afastar o conteúdo da navbar fixa. */
            padding-top: 70px; /* Ajuste o valor se o header for mais alto (ex: 80px) */
        }
    </style>
    </head>
                    ...
                    if (isset($_SESSION['logged'])): ?>
                        ...
                        switch ($_SESSION['func_tipo_acesso']) {
                            ...
                            case '3': // Coordenação
                                ?>
                                <li class="nav-item"><a class="nav-link text-dark fw-medium" href="./inicio"><i class="fas fa-home me-1"></i> Início</a></li>
                                <li class="nav-item"><a class="nav-link text-dark fw-medium" href="./relatorios"><i class="fas fa-chart-bar me-2"></i> Relatórios</a></li>
                            ...
                            case '4': // Administrador
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="cadastrosDropdown">
                                        <li><h6 class="dropdown-header">Pessoas e Estrutura</h6></li>
