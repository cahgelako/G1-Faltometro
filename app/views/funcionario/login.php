...
<head>
    ...
    <style>
        ...
        body.login-body {
            ...
            margin: 0;
            padding: 20px;
            /* Adiciona um pequeno padding para telas menores */
        }
        ...
        .card-login {
            ...
            /* Sombra mais destacada e profissional */
        ...
        .btn-primary {
            ...
            color: white;
            /* Cor do texto branca para alto contraste */
            width: 100%;
            font-size: 1.1rem;
            padding: 0.75rem 0;
            /* Maior preenchimento */
        ...
        .btn-primary:hover {
            ...
            /* Azul ligeiramente mais escuro no hover */
            border-color: #6EB4D4;
            color: white;
        }
        ...
        .input-group-text {
            ...
            /* Fundo do ícone mais claro */
            border-right: none;
            color: var(--bs-primary-custom);
            /* Ícone no tom de azul */
            border-color: #dee2e6;
        }
